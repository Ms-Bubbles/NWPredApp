shinyUI(fluidPage(
        ...
        navlistPanel(
                ...
                tabPanel("Application",
                         ...
                         textInput("ustring", label = h5("Text input. Prediction app will return (if available) alternative suggestions for the next word"), value = "Enter text here (min. 3 words)..."),
                         submitButton("Submit"),
                         hr(),
                         #                          fluidRow(column(3, verbatimTextOutput("cleanStr"))),
                         #                          hr(),
